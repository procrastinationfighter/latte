...
class AddOp(result: Int, left: OpArgument, right: OpArgument, addOp: AddOp): BinaryOp(result, left, right)
...
class MultiplicationOp(result: Int, left: OpArgument, right: OpArgument, mulOp: MulOp): BinaryOp(result, left, right)
